#!/usr/bin/env python3
"""Compute missing equity technicals in small batches."""
...
def main(limit: int = 50, offset: int = 0):
    ...
    cur.close()
    print(f"Batch offset={offset}, limit={limit}, processing {len(missing_ids)} equities")
    ...
    for inst_id in missing_ids:
        ...
        """, (
            ...
            float(vol_20d.iloc[-1]) if pd.notna(vol_20d.iloc[-1]) else None,
